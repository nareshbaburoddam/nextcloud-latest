...
namespace OCA\Notifications\Vendor\Brick\Math;

use OCA\Notifications\Vendor\Brick\Math\Exception\DivisionByZeroException;
use OCA\Notifications\Vendor\Brick\Math\Exception\IntegerOverflowException;
use OCA\Notifications\Vendor\Brick\Math\Exception\MathException;
use OCA\Notifications\Vendor\Brick\Math\Exception\NegativeNumberException;
use OCA\Notifications\Vendor\Brick\Math\Exception\NumberFormatException;
use OCA\Notifications\Vendor\Brick\Math\Exception\RoundingNecessaryException;
use OCA\Notifications\Vendor\Brick\Math\Internal\Calculator;
use OCA\Notifications\Vendor\Brick\Math\Internal\CalculatorRegistry;
