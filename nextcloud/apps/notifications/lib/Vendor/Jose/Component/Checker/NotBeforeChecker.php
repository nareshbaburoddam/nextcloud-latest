...
namespace OCA\Notifications\Vendor\Jose\Component\Checker;

use Override;
use OCA\Notifications\Vendor\Psr\Clock\ClockInterface;
...
final readonly class NotBeforeChecker implements ClaimChecker, HeaderChecker
{
    ...
    public function __construct(private ClockInterface $clock, private int $allowedTimeDrift = 0, private bool $protectedHeaderOnly = false)
    {
    }
    #[Override]
