...
use OCA\Notifications\Vendor\Jose\Component\Core\Util\Ecc\PublicKey;
class Utils
{
    ...
    {
        $requiredExtensions = ['curl' => '[WebPush] curl extension is not loaded but is required. You can fix this in your php.ini.', 'mbstring' => '[WebPush] mbstring extension is not loaded but is required for sending push notifications with payload or for VAPID authentication. You can fix this in your php.ini.', 'openssl' => '[WebPush] openssl extension is not loaded but is required for sending push notifications with payload or for VAPID authentication. You can fix this in your php.ini.'];
    ...
    public static function checkRequirementKeyCipherHash(): void
    {
        ...
        $requiredCurves = ['prime256v1' => '[WebPush] Openssl does not support required curve prime256v1.'];
        ...
        $requiredCiphers = ['aes-128-gcm' => '[WebPush] Openssl does not support required cipher aes-128-gcm.'];
        ...
        $requiredHash = ['sha256' => '[WebPush] Php does not support required hmac hash sha256.'];
