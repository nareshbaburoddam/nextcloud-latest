...
use OCA\Notifications\Vendor\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `OCA\Notifications\Vendor\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `OCA\Notifications\Vendor\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
