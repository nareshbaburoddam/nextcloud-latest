...
namespace OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate;
...
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\AuthorityKeyIdentifierExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\BasicConstraintsExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\CertificatePoliciesExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\CRLDistributionPointsExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\ExtendedKeyUsageExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\Extension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\InhibitAnyPolicyExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\IssuerAlternativeNameExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\KeyUsageExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\NameConstraintsExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyConstraintsExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyMappingsExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectAlternativeNameExtension;
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectKeyIdentifierExtension;
use Traversable;
use function count;
/**
