...
use OCA\Notifications\Vendor\SpomkyLabs\Pki\X509\Certificate\Extension\Target\Target;
...
final class ACValidationConfig
{
     ...
     */
    private function __construct(private readonly CertificationPath $holderPath, private readonly CertificationPath $issuerPath)
    {
